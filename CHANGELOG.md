...
## Unreleased
### Fixed
-  Events are visible in the app even though their ids are in the "originating calendar id" blacklist [#158](https://github.com/rokwire/gateway-building-block/issues/158)
