...
## Unreleased
### Added
- Set up Gateway BB [#172](https://github.com/rokwire/gateway-building-block/issues/172)
...
## [2.20.0] - 2026-01-29
### Added 
- Set longer timeout to process the images [#182](https://github.com/rokwire/gateway-building-block/issues/182)

## [2.19.1] - 2026-01-28
### Fixed
- Fix Webtools event image handling [#178](https://github.com/rokwire/gateway-building-block/issues/178)

## [2.19.0] - 2026-01-26
### Changed
- Webtools events not showing images [#175](https://github.com/rokwire/gateway-building-block/issues/175)

## [2.18.0] - 2025-12-15
### Changed
- Update Webtools event XML URL [#169](https://github.com/rokwire/gateway-building-block/issues/169)
