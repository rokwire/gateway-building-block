...
// WebtoolsCalendarID defines model for WebtoolsCalendarID.
type WebtoolsCalendarID struct {
	CalendarId *string `json:"calendar_id,omitempty"`
	Count      *int    `json:"count,omitempty"`
}

// WebtoolsCalendarIDs defines model for WebtoolsCalendarIDs.
type WebtoolsCalendarIDs struct {
	BlacklistedCalendarIds *[]WebtoolsBlacklistItems `json:"blacklisted_calendar_ids,omitempty"`
	WebtoolsCalendarIds    *[]WebtoolsCalendarID     `json:"webtools_calendar_ids,omitempty"`
}
